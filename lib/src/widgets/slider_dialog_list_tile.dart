...
/// A [ListTile] that displays a title and a numeric value, and allows the user to change the value
/// using a [Slider] that is displayed in a dialog.
///
/// When the user taps the list tile, the dialog is displayed. The user can drag the slider and tap
/// the OK button to change the value.
///
/// ```dart
...
class SliderDialogListTile extends StatelessWidget {
  ...
  /// The current value that is displayed in the subtitle of the list tile, and used as the
  /// currently selected value for the slider.
  final double value;
  ...
  /// Called when the user changes the value using the slider and clicks the OK button.
  final ValueChanged<double>? onChanged;

  /// Called when the value should be displayed in the list tile and in the Slider dialog.
  ///
  /// You can use this callback to customize the way the value is displayed to the user.
  ///
              ...
              return Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(_displayValue(newValue), style: _valueTextStyle(context)),
                  ),
                  Slider(
                    value: newValue,
                    min: min,
